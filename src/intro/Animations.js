...
const AnimationUpDown = function($dataArray,$colors){
...
export AnimationReset;
export AnimationUpDown;
export AnimationLeftRight;
export AnimationColorDance;
export AnimationColorCycle;
